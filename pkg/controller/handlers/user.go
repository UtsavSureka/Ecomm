...
// UserLoginHandler is for login of user
// @Summary login a user
// @Description login and generate jwt token
// @Tags users
// @Accept  json
// @Produce  json
// @Param   user body UserLoginRequest true "login request"
// @Success 200 {object} UserLoginResponse
// @Failure 400 {object} UserLoginResponse
// @Failure 500 {object} UserLoginResponse
